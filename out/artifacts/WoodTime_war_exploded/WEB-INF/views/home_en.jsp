...
<head>
    ...
    <title>${siteTextEn[0].string}</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto my-2 my-lg-0 text-uppercase">
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#about">${siteTextEn[1].string}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#products">${siteTextEn[2].string}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#portfolio">${siteTextEn[3].string}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#contact">${siteTextEn[4].string}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="/woodtime">Рус</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-10 align-self-end">
                <h1 class="text-uppercase text-white font-weight-bold">${siteTextEn[5].string}</h1>
            ...
            <div class="col-lg-8 align-self-baseline">
                ...
                <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about">${siteTextEn[7].string}</a>
            </div>
        </div>
    </div>
</header>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h2 class="text-white mt-0">${siteTextEn[8].string}</h2>
                <hr class="divider light my-4">
                <p class="text-white-50 mb-4">${siteTextEn[9].string}
                    <br>${siteTextEn[10].string}
                <ol class="square">
                    <c:forEach items="${workshopsEn}" var="workshop">
                        <li>${workshop.name}</li>
                    </c:forEach>
                </ol>
                </p>
                <a class="btn btn-primary btn-xl js-scroll-trigger" href="#products">${siteTextEn[11].string}</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-right">
                <h2 class="text-center mt-0" style="color: white">${siteTextEn[12].string}</h2>
                <hr class="divider light my-4">
                <br>
                <ul class="square" style="width: auto; background: rgba(0, 0, 0, 0.5)">
                    <c:forEach items="${productsEn}" var="product">
...
<section class="page-section bg-dark text-white">
    <div class="container text-center">
        <h2 class="mb-4">${siteTextEn[13].string}</h2>
        <a class="btn btn-primary btn-xl js-scroll-trigger" href="#contact">${siteTextEn[14].string}</a>
    </div>
</section>
...
<section class="page-section" id="contact">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h2 class="mt-0">${siteTextEn[15].string}</h2>
                <hr class="divider light my-4">
                <p class="text-muted mb-5">${siteTextEn[16].string}</p>
            </div>
        </div>
        <div class="row">
